...
export LD_LIBRARY_PATH=\"{rocm_home}/lib:{rocm_home}/hip/lib:{rocm_home}/opencl/lib:$LD_LIBRARY_PATH\"\n"
    )
}
...
export LD_LIBRARY_PATH=\"/opt/rocm-6.0/lib:/opt/rocm-6.0/hip/lib:/opt/rocm-6.0/opencl/lib:$LD_LIBRARY_PATH\"\n",
    ...
    fn test_normalize_env_contents_no_change() {
        ...
        // The result should contain the same key assignments (may differ in trailing newline)
