...
benchmark_log "Starting ROCm benchmarks..."
...
benchmark_info "Running ROCm pre-installation benchmarks..."
benchmark_run_named_json "$MANIFEST_PATH" "$LOG_FILE" all-pre

benchmark_success "ROCm benchmarks completed successfully"
exit 0
