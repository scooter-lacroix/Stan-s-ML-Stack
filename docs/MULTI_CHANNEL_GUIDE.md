...
|---------|--------------|-----------------|
| Legacy  | 6.4.3        | Conservative compatibility (RDNA 1/2) |
| Stable  | 7.2.3        | Production RDNA 3/4 environments |
| Latest  | 7.2.4        | Default choice, current ROCm production release |
