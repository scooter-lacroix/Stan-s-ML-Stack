...
benchmark_log "Starting MLPerf Inference benchmark..."
...
benchmark_info "Running all benchmarks..."
benchmark_run_named_json "$MANIFEST_PATH" "$LOG_FILE" all

benchmark_success "MLPerf Inference benchmark completed successfully"
exit 0
