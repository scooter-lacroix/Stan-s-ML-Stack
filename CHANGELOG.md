...
### Added
- ROCm 7.0.2 (Latest) as installation option with expanded RDNA 4 GPU support
- ROCm 7.9.0 (Preview) as experimental technology preview option
- ROCM_VERSION and ROCM_CHANNEL environment variable exports

### Changed
- Default ROCm version updated from 7.0.0 to 7.0.2
- ROCm version selector now offers 4 channels: Legacy (6.4.3), Stable (7.0.0), Latest (7.0.2), Preview (7.9.0)
